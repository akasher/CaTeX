...
class FracNode extends MultiChildNode<RenderFrac> with FunctionNode<RenderFrac> {
  FracNode(ParsingContext context) : super(context);

  @override
  FunctionProperties get properties => const FunctionProperties(arguments: 2, greediness: 2);
